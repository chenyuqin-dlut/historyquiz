...
Page({
  ...
  startLevel: function (e) {
    ...
    if (level_opacity == '0.5') {
      ...
      if (level_state == 0) {
        ...
        that.writeTime();
        wx.redirectTo({
          url: "/pages/level/" + (level_id + 1) + "/" + (level_id + 1)
        })
      }
    }
  },
  ...
  getLevel: function () {
    ...
    wx.getStorage({
      ...
      success: function (res) {
        console.log(res.data);
        var level_right_array = res.data;
        var level = that.data.level;
        ...
        if (level[0]['level_right'] / level[0]['level_all'] >= 0.8) {
          level[0]['level_state'] = 2;
          level[1]['level_state'] = 1;
          level[0]['level_image'] = "/images/3.png";
